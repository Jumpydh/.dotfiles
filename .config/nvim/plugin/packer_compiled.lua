...
_G.packer_plugins = {
  ...
  ["lualine-lsp-progress.nvim"] = {
    loaded = true,
    path = "/Users/marvin/.local/share/nvim/site/pack/packer/start/lualine-lsp-progress.nvim",
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/marvin/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  playground = {
    loaded = true,
    path = "/Users/marvin/.local/share/nvim/site/pack/packer/start/playground",
